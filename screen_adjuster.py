...
def draw_window_with_custom_values():
    ...
    if window_width <= 648:
        ...
        horizontal_border = window_width - 646 - 9

    if window_height <= 648:
        vertical_border = 2
    elif window_height >= 667:
        vertical_border = 21
    else:
        vertical_border = window_height - 646

    Screen().screensize(canvwidth=window_width - horizontal_border, canvheight=window_height - vertical_border)
    Screen().setup(window_width, window_height)
    print(window_width, window_height, horizontal_border, vertical_border)
    Screen().exitonclick()
